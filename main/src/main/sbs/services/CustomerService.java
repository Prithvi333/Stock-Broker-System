...
public interface CustomerService {
	...
	String addWalletMoney(String email, double amount, Map<String, Customer> customer, List<Customer> cus)
			throws InvalidEmail;

	void withdrawMoney(String email, String password, double amount, Map<String, Customer> customer,
			List<Transaction> tr);
